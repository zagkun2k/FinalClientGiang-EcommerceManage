...
export class EditProductComponent implements OnInit {
  ...
  selectFile!: File;
  url: string = 'https://res.cloudinary.com/martfury/image/upload/v1647784624/products/r0vvwojslqmpe094c2sx.jpg';
  ...
  getProduct() {
    this.productService.getOne(this.id).subscribe(data => {
      ...
      this.postForm = new FormGroup({
        ...
        'quantity': new FormControl(this.product.quantity, [Validators.min(0), Validators.required]),
